...
const SignUp = () => {
  ...
  const signUpState = useSelector((state) => state.checkAuth);
  ...
  return (
    <div className="signup-container min-h-full w-full  flex flex-col  ">
      <RetroGrid />
      {/* <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div> */}
      <Navbar />
      <div className="form-container h-full w-full flex justify-center items-center p-10">
        <div className="flex items-center justify-center p-4">
          <div className="w-full max-w-md">
            <div className="bg-white  dark:bg-black backdrop-blur-3xl  border mt-[20%] border-gray-200 dark:border-gray-800 rounded-2xl px-20 py-10 shadow-sm">
              <div className="form-header h-fit w-full flex flex-col items-center mb-5">
