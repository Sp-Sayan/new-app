...
export default function CardReveal() {
  return (<>
    <div
      className="py-20 flex flex-col lg:flex-row items-center justify-center bg-transparent w-full gap-4 mx-auto px-8">
      <Card title="SAYAN PAUL" icon={<AceternityIcon />}>
        <CanvasRevealEffect animationSpeed={5.1} containerClassName="bg-emerald-900" />
      </Card>
      <Card title="AARSHI MITRA" icon={<AceternityIcon />}>
        <CanvasRevealEffect
          animationSpeed={3}
