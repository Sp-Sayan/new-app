...
export const InfiniteMovingCards = ({
  ...
  return (
    (<div
      ref={containerRef}
      className={cn(
        "scroller relative z-50  max-w-7xl overflow-hidden  [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className
      )}>
      <ul
        ref={scrollerRef}
        ...
        {items.map((item, idx) => (
          <li
            ...
            style={{
              background:
                "linear-gradient(180deg, hsl(var(--primary)), hsl(347, 79%, 25%)",
            }}
            key={item.name}>
            <blockquote>
              <div
